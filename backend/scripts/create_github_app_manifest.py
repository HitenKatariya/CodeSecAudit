...
Usage:
    python backend/scripts/create_github_app_manifest.py
    python backend/scripts/create_github_app_manifest.py --org MyOrg
    python backend/scripts/create_github_app_manifest.py --help
"""
import argparse
import json
import os
...
REPO_URL = "https://github.com/hitenkatariya/CodeSecAudit"
...
def main():
    ...
    print(f"  Step 4: Run:")
    print(f'    python backend/scripts/complete_github_app_manifest.py --code YOUR_CODE')
    print()
