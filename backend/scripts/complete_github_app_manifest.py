...
Usage:
    python backend/scripts/complete_github_app_manifest.py --code TEMP_CODE
    python backend/scripts/complete_github_app_manifest.py --help
"""
import argparse
import base64
import json
...
def print_safe_summary(data: dict):
    ...
    print("    python backend/scripts/apply_github_app_env.py")
    print("    python backend/scripts/apply_github_app_env.py --write  (to actually write)")
    print()
