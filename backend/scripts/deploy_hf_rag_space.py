...
SPACE_ID = os.getenv("HF_RAG_SPACE_ID", "hitenvk22/codesec-rag-service")
SPACE_PRIVATE = os.getenv("HF_SPACE_PRIVATE", "").lower() in ("1", "true", "yes")
RAG_API_KEY = os.getenv("RAG_API_KEY", "")
RAG_DATASET_REPO = os.getenv("RAG_DATASET_REPO", "hitenvk22/CodeSecAudit-RAG-Shuffled")
...
def run_prepare():
    ...
    result = subprocess.run(
        [sys.executable, str(ROOT / "backend" / "scripts" / "prepare_hf_rag_space.py")],
        cwd=str(ROOT),
    )
